...
import "./ENG70x501.css";
import { useState } from "react";
import PortalPopup from "./PortalPopup";
import ENG70x50 from "./ENG70x50"

const ENG70x501 = ({ onClose }) => {
  const navigate = useNavigate();
  const [isENG70x501Open, setENG70x501Open] = useState(false);

  const openENG70x501 = useCallback(() => {
    setENG70x501Open(true);
  }, []);

  const closeENG70x501 = useCallback(() => {
    setENG70x501Open(false);
  }, []);
  ...
  return (
    ...
    <div className="x50" data-animate-on-scroll>
      ...
      <b className="b119">Pir'ina 70х50</b>
      <b className="b120">999 uah</b>
      <img
      ...
      <div className="group-parent5">
        <button className="rectangle-parent10" onClick={openENG70x501}>
    ...
    {isENG70x501Open && (
        <PortalPopup
          ...
          placement="Centered"
          onOutsideClick={closeENG70x501}
        >
          <ENG70x50 onClose={closeENG70x501} />
        </PortalPopup>
      )}
    </>
  );
